-- 007: 안심상속 원스톱 서비스 링크를 정확한 깊은 경로로 교체
--   기존: https://www.gov.kr  →  새 URL: https://www.gov.kr/portal/onestopSvc/safeInheritance
--   006을 이미 실행한 환경 대비. 함수와 기존 데이터 모두 갱신.
...
update checklist_items
   set link_url = 'https://www.gov.kr/portal/onestopSvc/safeInheritance'
 where title = '안심상속 원스톱 서비스 신청';
